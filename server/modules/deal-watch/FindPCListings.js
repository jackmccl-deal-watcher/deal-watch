const { getEbayListings, getEbayItem } = require("../../utils/ebay/EbayUtils")
...
const getPCListings = async () => {
    ...
    const listingsData = await getEbayListings(QUERY_KEYWORD, LISTING_LIMIT, DESKTOP_CATEGORY_CODE)
    ...
    for (let listingSummary of listingSummaries) {
        ...
        const itemInfo = await getEbayItem(itemHref)
