        ...
        if (!saved) {
            return(
                <div className='save-builds-control'>
                        <TextField className="save-builds-title-input" label="Build Title" variant="standard" value={title} onChange={handleTitleChange} />
            ...
            return(
                <div className='save-builds-control'>
                        <TextField className="save-builds-title-input" label="Build Title" variant="standard" value={title} disabled />
